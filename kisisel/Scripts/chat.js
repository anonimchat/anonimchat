                    ...
                    if (noti.numChildren() > 0 && Object.values(noti.val())[0].sendFrom === currentUserKey) {
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10" style="cursor:pointer;">
                                    <div class="name">${user.name}
                                        <button class="btn btn-sm btn-defualt" style="float:right;"><i class="fas fa-user-plus"></i> İstek Gönderildi</button>
                                    </div>
                                </div>
                            </div>
                        </li>`;
                        ...
                        dbNoti.orderByChild('sendFrom').equalTo(data.key).on('value', function(noti) {
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10" style="cursor:pointer;">
                                    <div class="name">${user.name}
                                        <button class="btn btn-sm btn-defualt" style="float:right;"><i class="fas fa-user-plus"></i> Arkadaşsınız</button>
                                    </div>
                                </div>
                            </div>
                        </li>`;
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10" style="cursor:pointer;">
                                    <div class="name">${user.name}
                                        <button onclick="SendRequest('${data.key}')" class="btn btn-sm btn-primary" style="float:right;"><i class="fas fa-user-plus"></i> İstek Gönder</button>
                                    </div>
                                </div>
                            </div>
                        </li>`;
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10" style="cursor:pointer;">
                                    <div class="name">${noti.name}
                                        <button onclick="Reject('${data.key}')" class="btn btn-sm btn-danger" style="float:right;margin-left:1%;"><i class="fas fa-user-times"></i> Reddet</button>
                                        <button onclick="Accept('${data.key}')" class="btn btn-sm btn-success" style="float:right;"><i class="fas fa-user-check"></i> Onayla</button>
                                    </div>
                                </div>
                            </div>
                        </li>`;
